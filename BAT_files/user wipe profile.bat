...
:USERPRESERVE
set userpreserve="Administrator,All Users,UpdatusUser,Default,Default User,Default.migrated,DefaultAppPool,Public,mcmcadmin,ScriptLogicAdmin,Slogics,mcmcadmin.CHECKOUTPC,travisd,maudiec"
